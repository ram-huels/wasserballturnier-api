...
@RestController
public class MannschaftApiController implements MannschaftApi {

    private static final Logger log = LoggerFactory.getLogger(MannschaftApiController.class);

    private final MannschaftService mannschaftService;

    public MannschaftApiController(MannschaftService mannschaftService) {
